...
* R and RStudio instlled on your laptop
* The `tidyverse` R package
* The *Perceptions of Uncertainty* dataset from [https://github.com/zonination/perceptions/blob/master/probly.csv](https://github.com/zonination/perceptions/blob/master/probly.csv)
